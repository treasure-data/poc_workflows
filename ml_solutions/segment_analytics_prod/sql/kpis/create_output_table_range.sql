...
WHERE TD_TIME_RANGE(${td.each.unixtime_col}, '${filters.time_range_start_date}', '${filters.time_range_end_date}') AND TD_TIME_STRING(${td.each.unixtime_col}, 'd!') > '${td.last_results.max_date}'
